	...
	<section id="reviewWrap">
		...
		<c:forEach var="proReview" items="${proReview}">
			...
			<div class="userReview clearfix">
				...
				<input id="reviewCon" type="text" value="${proReview.reviewContent}"
					disabled>
			...
			<div class="textWrap">
				<form id="reviewModify">
					<textarea name="reviewContent" rows="3" cols="100" maxlength="100"
						autofocus>${proReview.reviewContent}
						</textarea>
					<input id="reviewNo" name="reviewNo" type="hidden"
						value="${proReview.reviewNo}" />
				</form>
			...
			<div id="reviewTextWrap">
				<form id="RereviewModify">
					<input id="reviewNo" name="reviewNo" type="hidden"
						value="${proReview.reviewNo}" /> <input id="pNo" name="pNo"
						type="hidden" value="${proDetail.pNo}" /> <input id="rsvNO"
						name="rsvNO" type="hidden" value="80001" /> <input id="order"
						name="order" type="hidden" value="1" /> <input id="depth"
						name="depth" type="hidden" value="1" />
					<textarea name="reReviewsContent" rows="3" cols="100"
						maxlength="100" autofocus>
						</textarea>
				</form>
				<div id="reviewTextBtn">
					<button type="button" onclick="insertReReview()">등록</button>
